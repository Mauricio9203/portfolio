...
const TituloHabilidades = () => {
  ...
  return (
    <Grid container justifyContent="center" alignItems="center" spacing={4} mb={-5} >
        ...
        <Grid item md={9} xs={12} >
          <Card sx={{ backgroundColor: darkMode ? "black" : "black", color: darkMode ? "white" : "white", height: "60px" }}>
            <CardContent sx={{ display: 'flex', justifyContent: 'center' }}>
              <CodeIcon sx={{ fontSize: 30, marginRight: 2 }} />
              <Typography variant="h5">
                {translate("Habilidades")}
              </Typography>
            </CardContent>
          </Card>
        </Grid>
...
export default TituloHabilidades;
